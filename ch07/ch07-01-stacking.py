...
# models.py에 Model1Xgb, Model1NN, Model2Linear을 정의하는 것으로 한다.
# 각 클래스는 fit로 학습하고 predict로 예측값 확률을 출력

from models import Model1Xgb, Model1NN, Model2Linear

# 학습 데이터에 대한 「목적 변수를 모르는」예측값과 테스트 데이터에 대한 예측값을 반환하는 함수
def predict_cv(model, train_x, train_y, test_x):
    ...
    # 교차 검증으로 학습・예측을 하여 예측값과 인덱스를 보존
...
# 첫번째 층의 모델
# pred_train_1a, pred_train_1b은 학습 데이터의 검증에서의 예측값
...
# 예측값을 특징(feature)으로 데이터 프레임을 작성
...
# 두번째 층의 모델
# pred_train_2는 두 번째 모델의 학습 데이터로 교차 검증에서의 예측값
# pred_test_2는 두번째 모델의 테스트 데이터 예측값
